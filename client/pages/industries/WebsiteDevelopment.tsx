  ...
  const features = [
    {
      ...
      title: "Modern Design",
      description: "Clean, professional websites that reflect your brand and engage your audience."
    },
    {
    ...
    },
    {
      ...
      description: "Fast-loading websites built for optimal user experience and search rankings."
    },
    {
    ...
    },
    {
      ...
      description: "Enterprise-grade security and reliable hosting for peace of mind."
    },
    {
      icon: <Palette className="w-8 h-8 text-onealgo-orange-500" />,
      title: "Custom Solutions",
      description: "Tailored functionality and integrations to meet your specific business needs."
    }
  ];
      ...
      <section className="bg-gradient-to-br from-onealgo-blue-950 via-onealgo-blue-900 to-onealgo-blue-800 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <svg className="w-24 h-24 text-blue-500 mx-auto mb-6 animate-bounce-slow" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive web development services that create digital experiences designed to engage users and drive results.
            </p>
          </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-600">
                    <strong>Professional Results:</strong> Clean, modern designs that establish credibility and trust.
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <p className="text-gray-600">
                    <strong>Better Performance:</strong> Fast-loading, optimized websites improve user experience and search rankings.
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <p className="text-gray-600">
                    <strong>Mobile-First Design:</strong> Responsive layouts ensure your site works perfectly on all devices.
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <p className="text-gray-600">
                    <strong>Custom Functionality:</strong> Tailored solutions that meet your unique business requirements.
                  </p>
                </div>
              </div>
            </div>
            <div className="bg-white rounded-lg shadow-lg p-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Ready to Build Your Website?</h3>
