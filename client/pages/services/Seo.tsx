...
import { Globe, TrendingUp, Link as LinkIcon, CheckCircle, BarChart3 } from "lucide-react";
    ...
    <Layout>
      ...
      <section className="bg-gradient-to-br from-onealgo-blue-950 via-onealgo-blue-900 to-onealgo-blue-800 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <svg className="w-24 h-24 text-onealgo-orange-500 mx-auto mb-6 animate-bounce-slow" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM11 6h2v6h-2zM11 14h2v2h-2z" />
            </svg>
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              SEO Services &nbsp;
              <span className="text-onealgo-orange-500">for Sustainable Growth</span>
            </h1>
            <p className="text-xl text-blue-200 max-w-3xl mx-auto mb-8">
              Technical SEO, content strategy, and analytics-driven optimization to increase qualified organic traffic and revenue.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button asChild size="lg" className="bg-onealgo-orange-500 hover:bg-onealgo-orange-600 text-white px-8 py-4">
                <Link to="/contact">Request an SEO Audit</Link>
              </Button>
              <Button asChild size="lg" className="bg-white/10 hover:bg-white/20 text-white px-8 py-4">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">SEO Capabilities</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Full-service SEO: from technical fixes to content and outreach that drive measurable results.
            </p>
          </div>
      ...
      <section className="py-20 bg-onealgo-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-3xl font-bold text-gray-900 mb-6">Why OneAlgorithm for SEO?</h3>
              <ul className="space-y-4 text-gray-600">
                <li>Proven track record increasing organic sessions and conversions.</li>
                <li>Technical-first approach to fix root causes of poor visibility.</li>
                <li>Content programs aligned to product/market fit and revenue goals.</li>
                <li>Transparent reporting and continuous improvement via testing.</li>
              </ul>
            </div>
            <div className="bg-white rounded-lg shadow-lg p-8">
              <h4 className="text-2xl font-bold text-gray-900 mb-4">Get an SEO Audit</h4>
              <p className="text-gray-600 mb-6">Our audit includes site crawl, Core Web Vitals review, content gaps, and prioritized fixes with estimated impact.</p>
              <Button asChild size="md" className="bg-onealgo-blue-950 hover:bg-onealgo-blue-900 text-white px-6 py-3">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto mb-8">Case studies, improved rankings, and traffic growth across client sites — available on request.</p>
          <SocialShare />
        </div>
      </section>
    </Layout>
